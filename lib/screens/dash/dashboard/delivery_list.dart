    ...
    showDialog<void>(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Container(width: 500, height: 500, child: DialogDeliver()),
            actions: <Widget>[
              FlatButton(
                child: Text('Ok', style: TextStyle(color: Colors.black)),
                onPressed: () {
                  firestore.collection("delivery").doc(documentId).update({
                    "livreur_id": DialogDeliver().h,
                    "status": 4
                  }).whenComplete(() => null);
